...
This Wikipedia article was referenced by [Wikipedia's article on the adverse effects of wireless device radiation on human health](../../../2025/11/05/wikipedia_wireless_device_radiation_and_health.md). It answered two questions about electromagnetic radiation.

## What happens to matter when electromagnetic radiation passes through it?

It depends on the energy of the photon that collides with the atom. If the energy is above the ionization energy of an atom (i.e., >10eV) and it encounters an electron, the electron will be knocked off the atom. If the energy is below the ionization threshold, then the photon will excite the particle it strikes without causing an ejection of an electron. When there are enough of such excitations, the temperature of the object bombarded by EMR rises.
...
UV radiation is between non-ionizing and ionizing radiation on the ionization continuum. Even the non-ionizing near-UV radiation has high enough energy to produce free radicals.

> Near ultraviolet radiation, although technically non-ionizing, may still excite and cause photochemical reactions in some molecules. This happens because at ultraviolet photon energies, molecules may become electronically excited or promoted to free-radical form, even without ionization taking place.

Ionization is not the only way to damage the DNA molecule.

> Pyrimidine dimer formation in DNA can happen through most of the UV band, including much of the band that is formally non-ionizing.

## What part of the electromagnetic spectrum is sunlight?
